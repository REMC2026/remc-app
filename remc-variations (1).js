...
(function (root) {
  ...
  // -------------------------------------------------------------- escrita ---
  // Nao por texto: ver o comentario em remc-data.js. Comparado por texto, um
  // registo que voltou do servidor parece sempre diferente daquele que temos,
  // e a pagina grava outra vez o que nao mudou - de dois em dois segundos.
